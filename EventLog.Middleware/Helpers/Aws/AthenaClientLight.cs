...
{
    public static class AthenaClientLight
    {
        public static async Task<GetQueryResultsResponse> QueryAsyncLight(this IAmazonAthena client, StartQueryExecutionRequest request, int timeoutSeconds)
        {
